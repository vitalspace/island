...
<script lang="ts">
    ...
    let { player = {x: 0, y: 0, z: 0}, socket = null, fallback = () => {}, error = () => {}, children =  () => {}, ref = $bindable(), ...props } = $props()
  ...
  <T.Group
    {position} bind:ref={mainGroupRef}
    dispose={false}
    {...props}
  >
    {#await gltf}
